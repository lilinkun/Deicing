 ...
 */
package com.communication.deicing.http.convert;
        ...
        if (rawType != ResponseData.class) {
            ...
            if (typeArgument == Void.class) {
                ...
                if (code == 1111) {
                    ...
                    throw new IllegalAccessException("sorry"+lzyResponse.getMessage());
                }else {
                    //直接将服务端的错误信息抛出，onError中可以获取
                    throw new IllegalStateException("错误信息：" + lzyResponse.getMessage());
                }
            }
        }
    }
